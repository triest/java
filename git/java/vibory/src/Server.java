...
public class Server {
    ...
    String[] userAndPasseord;

    public String[] getUserAndPasseord() {
        return userAndPasseord;
    }

    public void setUserAndPasseord(String[] userAndPasseord) {
        this.userAndPasseord = userAndPasseord;
    }
    ...
    public Server() {
        try {
            ...
            voitingSystem.addUser("login","password","d");
    ...
    private class Connection extends Thread {
        ...
        public void run() {
            try {
                ...
                String str = "";
                while (true) {
                    if(str.equals("authorization")){System.out.println("authorization is redy");
                        while (true){
                            str=in.readLine();
                            userAndPasseord=str.split("&");
                            System.out.println(userAndPasseord[0]);
                            System.out.println(userAndPasseord[1]);
                            System.out.println("Login: "+voitingSystem.findUser2("login","password").getLogin());
                        }
