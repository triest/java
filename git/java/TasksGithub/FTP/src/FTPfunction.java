...
public class FTPfunction {
    ...
    public static boolean uploadFile(FTPClient ftpClient,String patchname) throws FileNotFoundException {
        OutputStream output = null;
        try {
...
//        return true;
       ...
       public boolean deleteFile(FTPClient client,String filename) throws IOException,FileNotFoundException {
       return client.deleteFile (filename);
               }


    public void setHostname(String hostname) throws NotConnectedExaption {
        this.hostname = hostname;
    }

    public String getHostname() throws NotConnectedExaption {
        return hostname;
    }

    public String getUsername()throws NotConnectedExaption {
        return username;
    }

    public void setUsername(String username)throws NotConnectedExaption {
        this.username = username;
    }

    public String getPassword()throws NotConnectedExaption {
        return password;
    }

    public void setPassword(String password)throws NotConnectedExaption {
