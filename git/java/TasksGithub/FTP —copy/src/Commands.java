...
public class Commands {
    ...
    public void applyCommand(String[] command, FTPClient client,FTPfunction ftPfunction,Console console) throws IOException, NotConnectedExaption {
    ...
    public static boolean upload(FTPClient client,Console console,FTPfunction ftPfunction) throws FileNotFoundException {
