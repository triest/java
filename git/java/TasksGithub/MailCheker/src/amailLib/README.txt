...
This release supports the following Internet standard mail protocols:
    ...
    IMAP - a message Store protocol, for reading inboxMessages from a server
    POP3 - a message Store protocol, for reading inboxMessages from a server
    SMTP - a message Transport protocol, for sending inboxMessages to a server
...
--------
    ...
    demo/msgshow.java	demo program to read inboxMessages from an IMAP store
    ...
    demo/uidmsgshow.java
			demo program to read inboxMessages from an IMAP store
