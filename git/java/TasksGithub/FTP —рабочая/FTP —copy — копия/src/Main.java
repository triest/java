...
public static void main(String[] args) throws IOException {
    ...
    ftPfunction.connect (ftpClient,"ufps.onego.ru","toall","Toalll");
    ftPfunction.changeDirectory (ftpClient,"pb");
    ftPfunction.downloadFile (ftpClient,"terrlist.rar","//");


    /*
   while (true){
        console.ascCommand (commands,client,ftPfunction,console);
   }*/
